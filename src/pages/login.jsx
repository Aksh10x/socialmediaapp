...
const Login = () => {
    ...
    return ( 
        ...
        <div className="max-w-[400px] w-[90%] h-[300px] flex flex-col justify-center items-center gap-6 bg-yellow-200 rounded-xl border-2 border-rose-900 shadow-yellow-400 shadow-inner">
            ...
            <button onClick={SignInGoogle} className="bg-yellow-400 px-2 py-4 rounded-lg border-[2.7px] text-lg font-extrabold text-white border-rose-900 w-[260px] shadow-xl shadow-yellow-500 hover:shadow-2xl hover:shadow-yellow-500 hover:scale-105 hover:translate-y-[-10px] transition-all">Login With Google</button>
        </div>
        </div>
     );
}
